...
const float L1=20, L2=17.503, L3=30;
const float PI = 3.1415926;

class Leg{
public:
    Leg(int _id, string Serial_Port, float _initPos[3], int _signal[3], bool _phaseBias, int _cycleChunking[4])
